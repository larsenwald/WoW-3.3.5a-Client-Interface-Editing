...
LOGIN_STATE_AUTHENTICATED = "Firing up the forge...";
LOGIN_STATE_AUTHENTICATING = "Firing up the forge...";
LOGIN_STATE_CHECKINGVERSIONS = "Validating Version";
LOGIN_STATE_CONNECTING = "Firing up the forge...";
LOGIN_STATE_DOWNLOADFILE = "Downloading";
LOGIN_STATE_HANDSHAKING = "Firing up the forge...";
...
LOGIN_UNKNOWN_ACCOUNT = "Wrong username or password. Please try again.";
...
RESPONSE_CONNECTED = "Firing up the forge...";
